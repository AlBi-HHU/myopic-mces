...
def test_filter0_tl():
    start = time.time()
    f0_data = pd.read_csv('testdata/f0_res.csv', header=None, names=['i', 'mces', 't', 'mode'])
...
def test_filter1_tl():
    start = time.time()
    f1_data = pd.read_csv('testdata/f1_res.csv', header=None, names=['i', 'mces', 't', 'mode'])
    smiles = pd.read_csv('testdata/test_smiles.csv', header=None, names=['i', 'smiles1', 'smiles2'])
...
def test_filter2_tl():
    start = time.time()
    f2_data = pd.read_csv('testdata/f2_res.csv', header=None, names=['i', 'mces', 't', 'mode'])
    smiles = pd.read_csv('testdata/test_smiles.csv', header=None, names=['i', 'smiles1', 'smiles2'])
...
def test_all_filters(): 
    ...
    special_idx = pd.read_csv('testdata/special_idx.csv', header=None, names=['i'])
    ...
    # smiles.loc[violation_01].set_index('i').to_csv('testdata/special.csv', header=None)
    

def test_same_as_main():
    start = time.time()
    main_df = pd.read_csv('testdata/bio_dists_main_mces.csv', header=None, names=['i', 'mces'])
    smiles = pd.read_csv('testdata/smiles_subset.csv', header=None, names=['i', 'smiles1', 'smiles2'])
